...
# tm = TuringMachine.new("1100111", "Mult.json")
# tm = TuringMachine.new("111000", "Mult.json")
# tm = TuringMachine.new("110000", "Mult.json")
tm = TuringMachine.new("10", "Mult.json")
